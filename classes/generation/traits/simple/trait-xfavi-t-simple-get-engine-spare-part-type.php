<?php
/**
 * Traits EngineSparePartType for simple products
 *
...
trait XFAVI_T_Simple_Get_EngineSparePartType {
	/**
	...
	public function get_engine_spare_part_type( $tag_name = 'EngineSparePartType', $result_xml = '' ) {
		...
		$tag_value = apply_filters(
			'xfavi_f_simple_tag_value_engine_spare_part_type',
			$tag_value,
		...
		if ( ! empty( $tag_value ) ) {
			$tag_name = apply_filters(
				'xfavi_f_simple_tag_name_engine_spare_part_type',
				$tag_name,
				[ 'product' => $this->get_product() ],
				$this->get_feed_id()
			);
		...
		$result_xml = apply_filters(
			'xfavi_f_simple_tag_engine_spare_part_type',
			$result_xml,
			[ 'product' => $this->get_product() ],
			$this->get_feed_id()
		);
