<?php
/**
 * Traits Technic_Spare_Part_Type for simple products
 *
...
trait XFAVI_T_Simple_Get_Technic_Spare_Part_Type {
	/**
	...
	public function get_technic_spare_part_type( $tag_name = 'TechnicSparePartType', $result_xml = '' ) {
		...
		$tag_value = apply_filters(
			'xfavi_f_simple_tag_value_technic_spare_part_type',
			$tag_value,
		...
		if ( ! empty( $tag_value ) ) {
			$tag_name = apply_filters(
				'xfavi_f_simple_tag_name_technic_spare_part_type',
				$tag_name,
				[ 'product' => $this->get_product() ],
				$this->get_feed_id()
			);
		...
		$result_xml = apply_filters(
			'xfavi_f_simple_tag_technic_spare_part_type',
			$result_xml,
			[ 'product' => $this->get_product() ],
			$this->get_feed_id()
		);
