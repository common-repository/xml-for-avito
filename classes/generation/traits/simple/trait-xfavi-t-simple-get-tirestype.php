<?php 
/**
 * Traits TiresType for simple products
 *
...
trait XFAVI_T_Simple_Get_TiresType {
	/**
	...
	public function get_tirestype( $tag_name = 'TiresType', $result_xml = '' ) {
		...
		$tag_value = apply_filters(
			'xfavi_f_simple_tag_value_tirestype',
			$tag_value,
			[ 
		...
		if ( ! empty( $tag_value ) ) {
			$tag_name = apply_filters(
				'xfavi_f_simple_tag_name_tirestype',
				$tag_name,
				[ 
					'product' => $this->get_product()
				],
