<?php 
/**
 * Traits ATF for simple products
 *
...
trait XFAVI_T_Simple_Get_Aft {
	 ...
	 * @return string
	 */
	public function get_aft( $tag_name = 'ATF', $result_xml = '' ) {
		$tag_value = '';
