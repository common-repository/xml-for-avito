<?php
/**
 * Traits BodySparePartType for simple products
 *
...
trait XFAVI_T_Simple_Get_BodySparePartType {
	/**
	...
	public function get_body_spare_part_type( $tag_name = 'BodySparePartType', $result_xml = '' ) {
		...
		$tag_value = apply_filters(
			'xfavi_f_simple_tag_value_body_spare_part_type',
			$tag_value,
		...
		if ( ! empty( $tag_value ) ) {
			$tag_name = apply_filters(
				'xfavi_f_simple_tag_name_body_spare_part_type',
				$tag_name,
				[ 'product' => $this->get_product() ],
				$this->get_feed_id()
			);
		...
		$result_xml = apply_filters(
			'xfavi_f_simple_tag_body_spare_part_type',
			$result_xml,
			[ 'product' => $this->get_product() ],
			$this->get_feed_id()
		);
